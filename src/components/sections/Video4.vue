...
// 视频数据
const videos = [
  { img: '/video4/x_2_20_new.png', video: '/video4/output_2_20_scene_new.mp4' },
    { img: '/video4/x_2_151_new.png', video: '/video4/output_2_151_scene_new.mp4' },
      { img: '/video4/x_2_580_new.png', video: '/video4/output_2_580_scene_new.mp4' },
        { img: '/video4/x3_180.png', video: '/video4/output_3_180_scene.mp4' },
          { img: '/video4/x_0_280.png', video: '/video4/output_0_280_scene.mp4' },
...
<template>
  <div>
    ...
    <el-col :span="18">
        <p>
          <!-- Pandaset数据集和Nuscenes相同，具有6个相机，捕获了360度环视场景，但是相机本身参数与nuscenes并不一致，我们为该数据集提供了一套特有的UCP构建参数，以兼容我们的模型。 -->
     While Once shares the 6-camera, 360° surround-view configuration of nuScenes, its intrinsic and extrinsic camera parameters are distinct. Consequently, we tailored a unique set of UCP parameters for Once to ensure its compatibility with our model. We assess the zero-shot generalization of our model by deploying the nuScenes-trained model directly on the Once dataset.
        </p>
      </el-col>
    </el-row>
