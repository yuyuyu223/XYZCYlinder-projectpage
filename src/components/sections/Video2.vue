...
// 视频数据
const videos = [
  { img: '/video2/x_166_new.png', video: '/video2/output_166_scene.mp4' },
  { img: '/video2/x_171_new.png', video: '/video2/output_171_scene_new.mp4' },
  { img: '/video2/x_148_new.png', video: '/video2/output_148_scene.mp4' },
  { img: '/video2/x_142_new.png', video: '/video2/output_142_scene.mp4' },
  { img: '/video2/x_163_new.png', video: '/video2/output_163_scene_new.mp4' },
  { img: '/video2/x_74_new.png', video: '/video2/output_74_scene_new.mp4' },
]
</script>
...
<template>
  <div style="margin-bottom: -160px;">
    ...
    <el-col :span="18">
     ...
     The Waymo dataset is equipped with only five cameras, capturing a forward-facing surround view that slightly exceeds 180 degrees. This configuration is incompatible with the full panoramic input expected by our UCP framework. To adapt this dataset for our model, we devised a view augmentation strategy. As illustrated in the figure below, we generate the missing rear views by symmetrically mirroring the three front-facing camera images. Concurrently, we apply a central symmetry transformation to the side-camera views. This process allows us to construct the complete 360-degree surround-view input required by the UCP model. We assess the zero-shot generalization of our model by deploying the nuScenes-trained model directly on the Waymo dataset.
        </p>
      </el-col>
    </el-row>
